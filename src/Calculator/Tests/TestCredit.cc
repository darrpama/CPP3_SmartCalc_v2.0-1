...
TEST(CreditCalculatorTestAnnuitet, CreditCalculatorAnnuitetPositive) {
  ...
  credit_data result = creditCalculator.CalculateCredit(1000000, 3, 20, credit_time_type::credit_year, annuitet);
...
TEST(CreditCalculatorTestDifferential, CreditCalculatorDifferentialPositive) {
  CreditModel creditCalculator;
  credit_data result = creditCalculator.CalculateCredit(1000000, 3, 20, credit_time_type::credit_year, differential);
